...
const runTest = (description, sandbox_flags) => {
  promise_test(async test => {
    ...
    // Create a link for the child frame to navigate to.
    const nav_target =
        new URL('./resources/send-back-base-url.html', location.href);
    ...
    assert_equals(child_base_uri2, String(nav_target));
